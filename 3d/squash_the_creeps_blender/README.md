...
This copy comes from revision `52e30044658448149b04e8f69b475eebbfbd8f6e`
of the official Godot demo projects' `4.3` branch. Unlike the upstream demo,
it references `art/player.blend` and `art/mob.blend` directly and omits their
pre-exported GLB files, so importing and exporting the game requires Blender.
The upstream MIT license is included as `LICENSE.md`.
